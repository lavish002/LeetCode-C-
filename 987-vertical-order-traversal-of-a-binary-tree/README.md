...
Column 2: Only node 7 is in this column.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper" style="user-select: auto;"></div></pre>
...
<pre style="position: relative; user-select: auto;"><strong style="user-select: auto;">Input:</strong> root = [1,2,3,4,5,6,7]
...
<pre style="position: relative; user-select: auto;"><strong style="user-select: auto;">Input:</strong> root = [1,2,3,4,6,5,7]
<strong style="user-select: auto;">Output:</strong> [[4],[2],[1,5,6],[3],[7]]
<strong style="user-select: auto;">Explanation:</strong>
